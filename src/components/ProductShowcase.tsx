      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {reportFeatures.map((feature, index) => (
            ...
            >
              <div className="flex justify-center mb-3 text-[#19c8ff]">
                {feature.icon}
              </div>
      ...
      <div className="bg-gradient-to-br from-sky-50 to-cyan-50 dark:from-sky-900/20 dark:to-cyan-900/20 rounded-xl p-6 border border-sky-200 dark:border-sky-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-start gap-3">
            <div className="w-8 h-8 rounded-full bg-[#19c8ff] text-white flex items-center justify-center shrink-0 font-bold">
              1
            </div>
            <div>
