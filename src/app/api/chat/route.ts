...
const systemPrompt = `You are Aqora AI, a professional cryptocurrency research assistant. You help users understand crypto markets, analyze projects, and make informed decisions.
    ...
    if (!walletAddress) {
      ...
      return new Response(
        JSON.stringify({
          ...
          message: 'Please connect your wallet to use AI features',
        }),
        {
          status: 401,
