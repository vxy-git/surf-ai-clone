  ...
  return (
    <div className="min-h-screen bg-[#f7f7f7] dark:bg-gray-900">
      ...
      <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between sticky top-0 z-10">
        <h1 className="text-2xl font-bold bg-gradient-to-r from-[#19c8ff] to-[#0aa3d8] bg-clip-text text-transparent">
          {about.title}
        </h1>
        <Link
          href="/"
          className="px-6 py-2 bg-gradient-to-r from-[#19c8ff] to-[#0aa3d8] text-white rounded-full font-medium hover:shadow-lg hover:scale-105 transition-all"
        >
          {about.launchApp} →
        </Link>
      </header>
      ...
      <main className="w-full overflow-y-auto">
            <div className="max-w-4xl mx-auto px-6 py-12">
              ...
              <section className="mb-16">
                <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-[#19c8ff] to-[#0aa3d8] bg-clip-text text-transparent">
                  {about.heroTitle}
                </h2>
              ...
              <section className="mb-16">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    <h4 className="text-xl font-semibold mb-3 text-[#19c8ff]">
                      {about.agentLayer}
                    </h4>
              ...
              <section className="mb-16">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    <span className="text-[#19c8ff] text-xl mt-1">•</span>
                    <div>
              ...
              <section className="mb-16">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    <h4 className="text-lg font-semibold mb-2 text-[#19c8ff]">{about.useCase1}</h4>
                    <p className="text-gray-600 dark:text-gray-300">{about.useCase1Desc}</p>
                  </div>
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    <h4 className="text-lg font-semibold mb-2 text-[#19c8ff]">{about.useCase2}</h4>
                    <p className="text-gray-600 dark:text-gray-300">{about.useCase2Desc}</p>
                  </div>
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    <h4 className="text-lg font-semibold mb-2 text-[#19c8ff]">{about.useCase3}</h4>
                    <p className="text-gray-600 dark:text-gray-300">{about.useCase3Desc}</p>
                  </div>
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    <h4 className="text-lg font-semibold mb-2 text-[#19c8ff]">{about.useCase4}</h4>
              ...
              <section className="mb-16">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-cyan-50 to-sky-50 dark:from-cyan-900/20 dark:to-sky-900/20 rounded-xl p-6 border border-cyan-200 dark:border-cyan-700">
                    <h4 className="text-xl font-semibold mb-4 text-[#0aa3d8]">{about.forDevelopers}</h4>
                    <p className="text-gray-600 dark:text-gray-300 whitespace-pre-line">
                      {about.developersDesc}
                    </p>
                  </div>
                  <div className="bg-gradient-to-br from-sky-50 to-cyan-50 dark:from-sky-900/20 dark:to-cyan-900/20 rounded-xl p-6 border border-sky-200 dark:border-sky-700">
                    <h4 className="text-xl font-semibold mb-4 text-[#0aa3d8]">{about.forPowerUsers}</h4>
                    <p className="text-gray-600 dark:text-gray-300 whitespace-pre-line">
              ...
              <section className="mb-16">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                    <Check className="w-5 h-5 text-[#19c8ff]" />
              ...
              <footer className="pt-12 border-t border-gray-200 dark:border-gray-700 text-center text-gray-500 dark:text-gray-400">
                ...
                <div className="flex justify-center gap-6 text-sm mb-6">
                  <a href="#" className="hover:text-[#19c8ff] transition-colors">{about.documentation}</a>
                  <a href="#" className="hover:text-[#19c8ff] transition-colors">{about.careers}</a>
                  <a href="#" className="hover:text-[#19c8ff] transition-colors">{about.terms}</a>
                  <a href="#" className="hover:text-[#19c8ff] transition-colors">{about.privacy}</a>
                </div>
                <div className="flex justify-center items-center gap-6 text-sm">
                  ...
                  <a
                    ...
                    className="hover:text-[#19c8ff] transition-colors flex items-center gap-2"
                  >
